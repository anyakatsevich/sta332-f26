...
Just as the [derivative](differentiation.qmd) is the continuous analog to a discrete difference, the integral is the continuous analog to a discrete sum.
...
$$
What function, when you take its derivative, gives you $1/x^2=x^{-2}$? To answer that, you're essentially *undoing* the [power rule](differentiation.qmd#derivative-rules). After a while, you realize
$$
