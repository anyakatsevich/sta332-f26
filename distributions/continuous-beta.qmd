...
Every probability density is an [integral identity in disguise](../math/massage-and-squint.qmd#kernel-tricks), so we have that:
...
This is classic "massage and squint." We do a kernel-trick with the beta density, and we recall the properties of the gamma function from the [gamma function explainer](../math/gamma-function.qmd#properties).
